...
export function populateRemainingArticles(_p) {
  ...
  art("minilux-vs-pro.html", {
    ...
    body: _p(
      ...
      'Vill du jämföra officiella specs utan mellanhänder? <a href="https://www.miniprojekter.se/minilux" rel="dofollow">MiniLux</a> och <a href="https://miniprojektor.se/products/minilux-pro-smart-miniprojektor" rel="dofollow">MiniLux Pro</a> hos återförsäljaren – vi får ingen provision. Tvekar du mellan Pro och Pro 2 är det en annan jämförelse; läs <a href="minilux-pro-2.html">MiniLux Pro 2</a>.',
